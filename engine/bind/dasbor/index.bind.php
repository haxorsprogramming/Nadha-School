...
<head>
    <meta charset="UTF-8">
    <title>Dashboard - NadhaSchool</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

    <link rel="stylesheet" href="annisa/font/iconsmind-s/css/iconsminds.css" />
    <link rel="stylesheet" href="annisa/font/simple-line-icons/css/simple-line-icons.css" />
...
<body id="app-container" class="menu-default show-spinner">
    <nav class="navbar fixed-top">
        ...
        <a class="navbar-logo" href="#!">
            <img src="<?=STYLEBASE;?>/default/img/nadha_school.jpg" style="width:90px;">
        </a>
        ...
        <div class="navbar-right">
            <div class="header-icons d-inline-block align-middle">
                <div class="d-none d-md-inline-block align-text-bottom mr-3">
                    <div class="custom-switch custom-switch-primary-inverse custom-switch-small pl-1" 
                        data-toggle="tooltip" data-placement="left" title="Ubah ke Dark Mode">
            ...
            <div class="user d-inline-block">
                <button class="btn btn-empty p-0" type="button" data-toggle="dropdown" aria-haspopup="true"
                    ...
                    <span>
                        <img alt="Profile Picture" src="annisa/img/profiles/l-1.jpg" />
                    </span>
                </button>
    ...
    <?php $this->bind('dasbor/menuAdmin'); ?>
    
    <main>
        <div class="container-fluid" id='divTitleMap'>
            <div class="row">
                <div class="col-12">
                    <h1>{{utama}}</h1>
    ...
    <footer class="page-footer" id='divFooter'>
