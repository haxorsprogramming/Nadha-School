<div class="tab-pane fade show" id="informasidaftar" role="tabpanel" aria-labelledby="informasidaftar-tab">
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="txtAsalSekolah" name="txtAsalSekolah">
            </div>
            <div class="form-group">
                <label>No Ijazah</label>
                <input type="text" class="form-control" id="txtNoIjazah" name="txtNoIjazah">
            </div>
            <div class="form-group">
